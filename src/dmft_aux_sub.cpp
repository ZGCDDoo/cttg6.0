...
#include "Includes/IS/MarkovChainAuxSubMatrix.hpp"
...
int main(int argc, char **argv)
{
    ...
    //const size_t NWorkers = mpiUt::NWorkers();
    if (argc != 3)
    {
    ...
    using Markov_t = Markov::MarkovChainAuxSub<IOModel_t, Model_t>;
    ...
    SelfCon::SelfConsistency<IOModel_t, Model_t, H0_t> selfconUp(jj, model, greenImpurityUp, "Up");
    selfconUp.DoSCGrid();
